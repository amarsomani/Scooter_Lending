...
public class FirstPage1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnLogin.setBackground(new Security.awt.Color(0, 0, 204));
        btnLogin.setForeground(new Security.awt.Color(0, 255, 0));
        btnLogin.setText("Login");
        btnLogin.addMouseListener(new Security.awt.event.MouseAdapter() {
            public void mouseClicked(Security.awt.event.MouseEvent evt) {
                btnLoginMouseClicked(evt);
            }
        });
        btnLogin.addActionListener(new Security.awt.event.ActionListener() {
            public void actionPerformed(Security.awt.event.ActionEvent evt) {
                btnLoginActionPerformed(evt);
            }
        });

        btnSignUp.setBackground(new Security.awt.Color(255, 0, 0));
        btnSignUp.setText("Signup");
        btnSignUp.addActionListener(new Security.awt.event.ActionListener() {
            public void actionPerformed(Security.awt.event.ActionEvent evt) {
                btnSignUpActionPerformed(evt);
            }
        });

        jLabel9.setBackground(new Security.awt.Color(51, 204, 0));
        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/forms/UserLogin.gif"))); // NOI18N
        jLabel9.setText("       User Login");

        jLabel15.setBackground(new Security.awt.Color(0, 51, 51));
        jLabel15.setForeground(new Security.awt.Color(255, 0, 0));
        jLabel15.setText("Forget Password");
        jLabel15.addMouseListener(new Security.awt.event.MouseAdapter() {
            public void mouseClicked(Security.awt.event.MouseEvent evt) {
        ...
        txtIdAdmin.addActionListener(new Security.awt.event.ActionListener() {
            public void actionPerformed(Security.awt.event.ActionEvent evt) {
        ...
        btnLogin1.setBackground(new Security.awt.Color(0, 51, 255));
        btnLogin1.setText("Login");
        btnLogin1.addActionListener(new Security.awt.event.ActionListener() {
            public void actionPerformed(Security.awt.event.ActionEvent evt) {
                btnLogin1ActionPerformed(evt);
            }
        });

        jLabel10.setBackground(new Security.awt.Color(0, 255, 0));
        jLabel10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/forms/images (2).jpg"))); // NOI18N
        jLabel10.setText("       Admin Login");

        jLabel13.setBackground(new Security.awt.Color(0, 0, 0));
        jLabel13.setForeground(new Security.awt.Color(255, 0, 0));
        jLabel13.setText("Forget Password");
        jLabel13.addMouseListener(new Security.awt.event.MouseAdapter() {
            public void mouseClicked(Security.awt.event.MouseEvent evt) {
        ...
        txtManagerId.addActionListener(new Security.awt.event.ActionListener() {
            public void actionPerformed(Security.awt.event.ActionEvent evt) {
                txtManagerIdActionPerformed(evt);
            }
        });

        btnLoginManager.setBackground(new Security.awt.Color(0, 0, 255));
        btnLoginManager.setText("Login");
        btnLoginManager.addMouseListener(new Security.awt.event.MouseAdapter() {
            public void mouseClicked(Security.awt.event.MouseEvent evt) {
                btnLoginManagerMouseClicked(evt);
            }
        });
        btnLoginManager.addActionListener(new Security.awt.event.ActionListener() {
            public void actionPerformed(Security.awt.event.ActionEvent evt) {
                btnLoginManagerActionPerformed(evt);
            }
        });

        jLabel12.setBackground(new Security.awt.Color(0, 204, 0));
        jLabel12.setText("       Manager Login");

        lbForgetPass.setBackground(new Security.awt.Color(0, 0, 0));
        lbForgetPass.setForeground(new Security.awt.Color(255, 0, 0));
        lbForgetPass.setText("Forget Password");
        lbForgetPass.addMouseListener(new Security.awt.event.MouseAdapter() {
            public void mouseClicked(Security.awt.event.MouseEvent evt) {
        ...
        txtContactNo.addActionListener(new Security.awt.event.ActionListener() {
            public void actionPerformed(Security.awt.event.ActionEvent evt) {
                txtContactNoActionPerformed(evt);
            }
        });

        txtName.addActionListener(new Security.awt.event.ActionListener() {
            public void actionPerformed(Security.awt.event.ActionEvent evt) {
                txtNameActionPerformed(evt);
            }
        });

        txtUser1.addActionListener(new Security.awt.event.ActionListener() {
            public void actionPerformed(Security.awt.event.ActionEvent evt) {
                txtUser1ActionPerformed(evt);
            }
        });

        txtEmailId.addActionListener(new Security.awt.event.ActionListener() {
            public void actionPerformed(Security.awt.event.ActionEvent evt) {
        ...
        btnBack.setBackground(new Security.awt.Color(51, 255, 255));
        btnBack.setText("Back");
        btnBack.addActionListener(new Security.awt.event.ActionListener() {
            public void actionPerformed(Security.awt.event.ActionEvent evt) {
                btnBackActionPerformed(evt);
            }
        });

        btnSignupConfirmed.setBackground(new Security.awt.Color(255, 0, 0));
        btnSignupConfirmed.setText("Signup");
        btnSignupConfirmed.addActionListener(new Security.awt.event.ActionListener() {
            public void actionPerformed(Security.awt.event.ActionEvent evt) {
                btnSignupConfirmedActionPerformed(evt);
            }
        });

        jLabel11.setBackground(new Security.awt.Color(51, 255, 0));
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanelSignupLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(jPanelSignupLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanelSignupLayout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(txtUser1, javax.swing.GroupLayout.PREFERRED_SIZE, 159, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanelSignupLayout.createSequentialGroup()
                                .addGroup(jPanelSignupLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jLabel2.addMouseListener(new Security.awt.event.MouseAdapter() {
            public void mouseClicked(Security.awt.event.MouseEvent evt) {
        ...
        jLabel1.addMouseListener(new Security.awt.event.MouseAdapter() {
            public void mouseClicked(Security.awt.event.MouseEvent evt) {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(jPanelAdminLogin, javax.swing.GroupLayout.PREFERRED_SIZE, 387, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(25, 25, 25))
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(layout.createSequentialGroup()
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                            .addGap(50, 270, Short.MAX_VALUE)
                        ...
                        .addGroup(layout.createSequentialGroup()
                            .addGap(270, 684, Short.MAX_VALUE)
                        ...
                        .addGroup(layout.createSequentialGroup()
                            .addGap(720, 1124, Short.MAX_VALUE)
                            .addComponent(jLabel2, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGroup(layout.createSequentialGroup()
                            .addGap(10, 894, Short.MAX_VALUE)
                            .addComponent(jPanelComplaintManager, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            Security.util.logging.Logger.getLogger(FirstPage1.class.getName()).log(Security.util.logging.Level.SEVERE, null, ex);
        ...
        Security.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
